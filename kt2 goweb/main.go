...
func inputAnimal() (string, animal.Animal) {
    ...
    fmt.Print("Введите тип животного с большой буквы (Жираф, Пума, Кенгуру): ")
    fmt.Scan(&animalType)
    ...
    switch animalType {
    case "Жираф":
        return animalType, &animal.Giraffe{AgeValue: age}
    case "Пума":
        return animalType, &animal.Cougar{AgeValue: age}
    case "Кенгуру":
        return animalType, &animal.Kangaroo{AgeValue: age}
    default:
